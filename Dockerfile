...
ENTRYPOINT ["java" ,"-cp","app:app/lib/*","com.peertutor.ReviewMgr.ReviewMgrApplication"]

# to use for ci cd
# ENTRYPOINT ["java" ,"-cp","app:app/lib/*","com.peertutor.ReviewMgr.ReviewMgrApplication", "-Dspring.profiles.active=docker"]
